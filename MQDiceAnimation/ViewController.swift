...
class ViewController: UIViewController {
    ...
    //骰子动画
    var diceAnimationView: MQDiceAnimationView?
    //正在进行色子动画
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<5 {
            ...
            btn.setTitle(typeTitle[i], for: .normal)
            if i == 0 {
        ...
        for i in 0..<3 {
            ...
            btn.setTitle(String(i + 1) + "个", for: .normal)
            if i == 2 {
                btn.backgroundColor = UIColor.red
            } else {
                btn.backgroundColor = UIColor.white
        ...
        startBtn.setTitle("摇一摇", for: .normal)
    ...
    func initDiceAnimationView() {
        if self.diceAnimationView == nil {
            self.diceAnimationView = MQDiceAnimationView(diceCount: getDiceAnimationCount(), diceAnimationType: getDiceAnimationType(),animations:1.0)
